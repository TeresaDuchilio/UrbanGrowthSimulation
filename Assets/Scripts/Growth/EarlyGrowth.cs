...
public class EarlyGrowth 
{
    ...
    public EarlyGrowth()
    {
        ...
        maxDist = 0.1f;
        minStreetLength = 4.5f;
        maxStreetLength = 7.5f;
    }
    ...
    public void Initialize()
    {
        ...
        blockOne.building.height = 2f;
        blockOne.inhabitantCapacity = 10000;
        blockOne.UpdateBuilding();
        blockTwo.building.height = 2f;
        blockTwo.inhabitantCapacity = 10000;
    ...
    public IEnumerator Grow()
    {
        ...
        foreach (Node n in selected)
        {
            ...
            {
                blockHelper.newBlocks[j].historicalCenter = true;
    ...
    void CalculateNewMesh(Node node)
    {
        ...
        if (node.mesh != null)
            meshHelper.UpdateMesh(node.mesh, city.streetGraph.PickMaterial(node));
        else
            node.mesh = meshHelper.CreateMesh(city.streetGraph.PickMaterial(node), "corners");
